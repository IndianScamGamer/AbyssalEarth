...
def build():
    ...
    for side in [-1, 1]:
        ...
        # Wrist ring
        bmesh.ops.create_cone(bm, cap_ends=False, segments=10,
    ...
    bmesh.ops.create_cone(bm, cap_ends=False, segments=16,
    ...
    bmesh.ops.create_cone(bm, cap_ends=False, segments=14,
