...
### Remaining editor tasks

- Generate project files and compile to confirm the new crouch wiring, root-attached camera, beacon remove/recolor, ember vent hazard, journal widget, and `IA_Journal` toggle all build.
